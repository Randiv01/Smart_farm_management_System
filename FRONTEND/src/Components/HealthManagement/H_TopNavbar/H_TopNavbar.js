      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            {/* sun/moon */}
            {darkMode ? (
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a1 1 0 011 1v2a1 1 0 11-2 0V3a1 1 0 011-1zm0 13a5 5 0 100-10 5 5 0 000 10zm8-6a1 1 0 100-2h-2a1 1 0 100 2h2zM4 9a1 1 0 100-2H2a1 1 0 100 2h2zm11.657 6.657a1 1 0 10-1.414-1.414l-1.414 1.414a1 1 0 001.414 1.414l1.414-1.414zM6.171 6.171a1 1 0 10-1.414-1.414L3.343 6.171a1 1 0 101.414 1.414l1.414-1.414z"/></svg>
            ) : (
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20"><path d="M17.293 13.293A8 8 0 016.707 2.707 8.003 8.003 0 1017.293 13.293z"/></svg>
            )}
          </button>
          ...
          <div className="relative">
            ...
            >
              {/* user icon */}
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10 10a4 4 0 100-8 4 4 0 000 8zm-7 8a7 7 0 1114 0H3z"/></svg>
              <span>John Farmer</span>
              {/* chevron */}
              <svg xmlns="http://www.w3.org/2000/svg" className={`h-3 w-3 transform transition ${userMenuOpen ? 'rotate-180' : ''}`} fill="currentColor" viewBox="0 0 20 20"><path d="M5.23 7.21a.75.75 0 011.06.02L10 11.17l3.71-3.94a.75.75 0 011.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z"/></svg>
            </button>
            {userMenuOpen && (
              <div className={`absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 z-50 ${darkMode ? 'bg-green-800 border border-green-700' : 'bg-green-700 border border-green-600'}`}>
                <button
